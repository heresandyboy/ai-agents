...
import { AgentClassifier } from "./agents/classification/AgentClassifier";
import { LanguageModelFactory } from "./llm/factories/LanguageModelFactory";
import {
...
(async () => {
  ...
  for (const userInput of userInputs) {
    ...
    if ("textStream" in (response as PortkeyStreamResponse)) {
      ...
      const stream = (response as PortkeyStreamResponse).toDataStreamResponse();
